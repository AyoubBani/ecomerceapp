...
public class MainActivity extends AppCompatActivity {
    ...
    public void authentification(View view) {
        try {
            String result = new AsyncGetTask(this).execute("http://192.168.43.141:8080/login.php?login=" + login.getText().toString() + "&mdp=" + mdp.getText().toString()).get();
...
//        Toast.makeText(MainActivity.this,"LIVREUR",Toast.LENGTH_LONG).show();
        try {
            String result = new AsyncGetTask(this).execute("http://192.168.43.141:8080/livreur.php?idc=" + idu).get();
